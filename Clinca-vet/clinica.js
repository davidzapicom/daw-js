    ...
    if (mascotas.length == 0) {
        ...
        for (var i = 0; i < vacunas.length; i++) {
            if (mascotas[i].activo == "Active") {
                resultado.innerHTML += "<input type='button' class='vacunar' value='Vacunar' onclick='registrarVacuna(" + i + ")' /> " + vacunas[i].nombre + "-" + vacunas[i].nombreVacuna + "-" + vacunas[i].fechaVacuna + "<br />";
            }
        }
    }
}
